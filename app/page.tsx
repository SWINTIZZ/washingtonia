            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-emerald-100">
                  ...
                  <p>
                    Plus de 10 ans d'expérience dans le conseil agricole et l'accompagnement des agriculteurs marocains.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-teal-100">
                  ...
                  <p>
                    Contribuer à une agriculture marocaine plus durable, productive et respectueuse de l'environnement.
                  </p>
                </div>
              </div>
            </motion.div>
